...
namespace Solutions.test
{
    class TestInputs
    {
        public static string Day7bMonica { get; set; } = @"dihjv (2158) -> gausx, ncdmp, hozgrub
...
ihhmv (72)";
        ...
        public static string Day7bRyan { get; set; } = @"ifyzcgi (14)
axjvvur (50)
...
cl dec -167 if gi == 1209";
        ...
        public static string Day12Monica { get; set; } = @"0 <-> 889, 1229, 1736
1 <-> 1, 480, 793, 1361
2 <-> 607
3 <-> 273, 422
...
1999 <-> 1407, 1780, 1906, 1910";
        public static string Day12Ryan { get; set; } = @"0 <-> 780, 1330
1 <-> 264, 595, 1439
2 <-> 296, 531, 1440
3 <-> 207, 235, 1038
4 <-> 554, 1295
